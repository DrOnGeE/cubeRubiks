...
class Game(Ursina):
    ...
    def timer(self):
        ...
        res = round(time.time() - start_time, 0)
        time.sleep(1)
    ...
    def load_game(self):
        ...
        self.create_sensors()
        self.random_state(rotations=5) # initial state of the cube, rotations - number of side turns

        self.timer()

    def random_state(self, rotations=5):
